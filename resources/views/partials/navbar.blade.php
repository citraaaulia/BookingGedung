                    ...
                    <div class="menu">
                        ...
                        <ul>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a class='nav-link {{ ($title === "Riwayat Disposisi") ? "active" : "" }}' href="/RiwayatDisposisi">
                                            <span class="text">Disposisi</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a class='nav-link {{ ($title === "Riwayat Ditolak") ? "active" : "" }}' href="/RiwayatDitolak">
                                            <span class="text">Ditolak</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a class='nav-link {{ ($title === "Riwayat Selesai") ? "active" : "" }}' href="/RiwayatSelesai">
